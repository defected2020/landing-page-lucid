...
export const portfolioProjects = [
  {
    ...
    tagline: 'A network of wellness venues across Rishikesh — hotels, farmstays, and sacred spaces — unified under one digital experience.',
    summary: [
  ...
  },
  {
    ...
    tagline: 'Connecting spiritual seekers with authentic guides, facilitators, and venues through streaming, networking, and discovery.',
    summary: [
      'Atma Shambhala bridges the gap between spiritual seekers and authentic guides, facilitators, and venues — forming a conscious network for growth and connection.',
      'We built an immersive platform featuring a Netflix-style video library for streaming teachings, alongside tools for discovery, booking, and community.',
      'The result is a spacious, emotionally resonant digital space with a flexible foundation the team can scale as their network of practitioners grows.',
    ],
  ...
  },
  {
    ...
    tagline: 'Enterprise-grade loyalty platform with a revolutionary digital token system for reward exchanges.',
    summary: [
  ...
  },
  {
    ...
    tagline: 'A personal transformation app combining breathwork, meditation, fasting, mood tracking, and a social network for growth.',
    summary: [
      'Inner Sphere is a comprehensive personal development app weaving breathwork, meditation, fasting, mood tracking, and gratitude into one integrated practice.',
      'Beyond individual tools, the app features a revolutionary social network where users connect around personal development, spiritual growth, and growth hacking — turning self-improvement into a shared journey.',
      'Lucid Code Labs developed the complete product experience — from app to landing page — delivering a cohesive platform the team can extend with new practices and community features.',
    ],
    tags: ['Mobile app', 'Social network', 'Wellness', 'Personal development'],
    screenshots: [
