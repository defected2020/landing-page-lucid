...
import { activeSocialProfiles } from '../data/siteConfig';
...
// Keyed by profile id and rendered only for profiles marked enabled in
// siteConfig, so the contact section never links to an account that does not
// exist yet. Mirrors the same guard in components/Footer.js.
const SOCIAL_ICONS = {
  github: (
